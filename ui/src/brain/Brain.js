...
export class Brain extends HttpClient {
    constructor(config) {
        super({
     ...
     */
    check_health = (params = {}) => this.request({
        path: `/_healthz`,
        method: "GET",
        ...params,
    });
     ...
     */
    get_cl_access_token2 = (data, params = {}) => this.request({
     ...
     */
    get_commerce_layer_products = (query, params = {}) => this.request({
     ...
     */
    get_featured_products = async (query, params = {}) => {
        const response = await fetch(`/.netlify/functions/featured-products?market=${query.market}`, {
            method: 'GET',
            headers: {
     ...
     */
    get_product_details = ({ skuCode, ...query }, params = {}) => this.request({
     ...
     */
    get_core_cl_config = (params = {}) => this.request({
     ...
     */
    commerce_layer_health_check = (params = {}) => this.request({
