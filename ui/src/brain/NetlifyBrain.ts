...
export class NetlifyBrain {
   ...
   */
  async get_commerce_layer_products(
    query: GetCommerceLayerProductsParams & { page?: number; perPage?: number },
    ...
    try {
      ...
      const response = await fetch(
        `/.netlify/functions/products?${queryParams.toString()}`,
        {
          ...this.baseApiParams,
          ...params,
        }
  ...
  async get_featured_products(params: { market: string }) {
    try {
