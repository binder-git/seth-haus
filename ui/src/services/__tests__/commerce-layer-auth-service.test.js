...
describe('CommerceLayerAuthService', () => {
    ...
    describe('getAccessToken', () => {
        it('should successfully retrieve an access token', async () => {
            ...
            expect(mockedAxios.post).toHaveBeenCalledWith('/.netlify/functions/commerce-layer-auth', {}, { headers: { 'Content-Type': 'application/json' } });
        });
    ...
    describe('validateToken', () => {
        it('should validate a valid token', async () => {
            ...
            expect(mockedAxios.post).toHaveBeenCalledWith('/.netlify/functions/validate-token', { access_token: 'valid_token' }, { headers: { 'Content-Type': 'application/json' } });
        });
    ...
    describe('Token Storage and Validation', () => {
        ...
        it('should correctly determine token validity', () => {
            ...
            expect(CommerceLayerAuthService.isTokenValid(null)).toBe(false);
        });
